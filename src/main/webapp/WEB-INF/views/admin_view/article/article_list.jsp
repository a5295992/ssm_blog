...
<!--工具栏  -->
		...
		<table id="dg" class="easyui-datagrid" title="路径列表" style="width:100%;height:100%"
			data-options="
				...
				singleSelect: true,
				toolbar: '#tb',
				url: '${headpath }<%=AnRequest. A_ARTICLE_QUERY%>',
				method: 'get',
				pagination:'true'
			">
		<thead>
			<tr>
				...
				<th data-options="field:'id'" width="80" sortable="true">ID</th>
				<th data-options="field:'category',editor:'textbox',align:'center'" width="20%" >分类</th>
				<th data-options="field:'comments',editor:'textbox',align:'center'" width="15%">评论数</th>
				<th data-options="field:'blogId',width:60,align:'center',editor:{type:'checkbox',options:{on:'GET',off:'POST'}}">博客</th>
				<th data-options="field:'createBy',editor:'textbox',align:'center'" width="15%">用户</th>
