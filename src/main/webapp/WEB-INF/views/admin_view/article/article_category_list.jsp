...
<!--工具栏  -->
		...
		<thead>
			<tr>
				...
				<th data-options="field:'id'" width="80" sortable="true">ID</th>
				<th data-options="field:'name',editor:'textbox',align:'center'" width="20%" >名称</th>
				<th data-options="field:'createBy',editor:'textbox',align:'center'" width="15%">创建人</th>
				<th data-options="field:'blogId',width:60,align:'center',editor:{type:'checkbox',options:{on:'GET',off:'POST'}}">博客</th>
				<th data-options="field:'remarks',editor:'textbox',align:'center'" width="15%">备注</th>
				<th data-options="field:'_operate',width:80,align:'center',formatter:formatOper">编辑</th>  
			</tr>
		</thead>
	</table>
